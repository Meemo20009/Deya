         ...
         if   (mainForm.d1.value.trim()=="")
			...
			if (mainForm.t1.value != "")
					...
					if (mainForm.acc.checked!= false)
						...
						document.getElementById("rect").style.backgroundColor = "#EBF4FB";
					//	document.getElementById("description").style.backgroundColor = "black";
						//document.getElementById("rectngle").style.backgroundColor = "red";
	}
